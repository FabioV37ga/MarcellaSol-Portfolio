...
export function bathroom() {
    ...
    <div class="form-page-17">
                ...
                <p class="briefing-subtitle">
                    ...
                    planejar soluções alinhadas ao seu dia a dia e ao seu estilo.
                </p>
                ...
                <div class="briefing-input-box">
                    ...
                    <div class="briefing-options briefing-bathroom-storage">
                        ...
                        <label>
                            <input type="checkbox" name="form-input-116" value="outros">
                            <span>Outros</span>
                        </label>
                    </div>
                ...
                <div class="briefing-input-box">
                    <p>Acessibilidade, equipamentos específicos ou desejos especiais</p>
                    <span>
                        Descreva necessidades de acessibilidade, equipamentos desejados<br>
